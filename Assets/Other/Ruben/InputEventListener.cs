...
public class Key
{
    ...
    public Func<KeyCode,KeyCode> callback;
...
public class InputEventListener : MonoBehaviour
{
    ...
    private Dictionary<string,List<Key>> groups;
    public InputEventListener()
    {
        keys = new List<Key>();
        groups = new Dictionary<string, List<Key>>();
    ...
    public void listenTo(KeyCode keyCode,Func<KeyCode,KeyCode> callback)
    {
        Key key = new Key(keyCode);
        key.callback = callback;
        keys.Add(key);
    }
    public void listenTo(KeyCode keyCode,Func<KeyCode,KeyCode> callback, Func<KeyCode,bool> call)
    {
